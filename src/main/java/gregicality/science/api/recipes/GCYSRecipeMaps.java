...
public class GCYSRecipeMaps {
    ...
    public static final RecipeMap<PressureRecipeBuilder> PRESSURE_CHAMBER_RECIPES = new RecipeMap<>("pressure_chamber_recipes", 3, 4, 1, 1,     new PressureRecipeBuilder(), false)
